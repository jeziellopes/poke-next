...
import { PokemonParams } from '@/domain/usecases'
import { describe, expect, test } from '@jest/globals'

type SutTypes = {
  sut: RemotePokemon
  httpGetClientSpy: HttpGetClientSpy<PokemonResponseModel>
  pokemonLoadParams: PokemonParams
}

const makeSut = (url = 'any_url'): SutTypes => {
  const httpGetClientSpy = new HttpGetClientSpy<PokemonResponseModel>()
